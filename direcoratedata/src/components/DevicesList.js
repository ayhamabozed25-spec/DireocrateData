        ...
        <tbody>
          {filteredDevices.map((dev) => (
            <tr key={dev.id}>
              ...
              <td>{dev.status}</td>
              <td>
                <Button size="sm" variant="warning" className="me-2" onClick={() => handleEdit(dev)}>تعديل</Button>
                <Button size="sm" variant="danger" onClick={() => handleDelete(dev.id)}>حذف</Button>
              </td>
            </tr>
          ))}
        </tbody>
            ...
            <Form onSubmit={handleSaveEdit}>
              ...
              {(["لاب توب", "سيرفر", "تاب", "حاسوب مكتبي"].includes(editingDevice.type)) && (
                <Form.Group>
                  ...
                  <Formتمام، هذه نسخة كاملة من ملف **DevicesList.js** مع كل الحقول التي أرسلتها مدمجة داخل نافذة التعديل بشكل صحيح ومغلق بالكامل بدون نقص أو زيادات:
        ...
        <Modal.Body>
          {editingDevice && (
            <Form onSubmit={handleSaveEdit}>
              ...
              <Form.Group>
                <Form.Label>الحاجة</Form.Label>
                <Form.Select value={editingDevice.need} onChange={(e) => setEditingDevice({ ...editingDevice, need: e.target.value })} required>
                  <option value="">اختر</option>
                  <option value="مطلوب">مطلوب</option>
                  <option value="متوفر">متوفر</option>
                </Form.Select>
              ...
              <Form.Group>
                <Form.Label>نوع الجهاز</Form.Label>
                <Form.Select value={editingDevice.type} onChange={(e) => setEditingDevice({ ...editingDevice, type: e.target.value })} required>
                  <option value="">اختر</option>
                  <option value="لاب توب">لاب توب</option>
                  <option value="سيرفر">سيرفر</option>
                  <option value="حاسوب مكتبي">حاسوب مكتبي</option>
              ...
              {editingDevice.type === "أخرى" && (
                <Form.Group>
                  <Form.Label>نوع آخر</Form.Label>
                  <Form.Control value={editingDevice.otherType || ""} onChange={(e) => setEditingDevice({ ...editingDevice, otherType: e.target.value })} required />
                </Form.Group>
              )}
              ...
              {(["لاب توب", "سيرفر", "حاسوب مكتبي"].includes(editingDevice.type)) && (
                <>
                  <Form.Group>
                    <Form.Label>المعالج</Form.Label>
                    <Form.Select value={editingDevice.processor} onChange={(e) => setEditingDevice({ ...editingDevice, processor: e.target.value })} required>
                      <option value="">اختر</option>
                      <option value="Intel i3">Intel i3</option>
                      <option value="Intel i5">Intel i5</option>
                      <option value="Intel i7">Intel i7</option>
                  ...
                  {editingDevice.processor === "أخرى" && (
                    <Form.Group>
                      <Form.Label>معالج آخر</Form.Label>
                      <Form.Control value={editingDevice.otherProcessor || ""} onChange={(e) => setEditingDevice({ ...editingDevice, otherProcessor: e.target.value })} required />
                    </Form.Group>
                  )}
                </>
              )}
                  ...
                  <Row className="mt-3">
                    <Col md={8}>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => setEditingDevice({ ...editingDevice, cost: e.target.value })}
                        required
                      />
                    </Col>
                    <Col md={4}>
                      ...
                      <Form.Select
                        ...
                        onChange={(e) => setEditingDevice({ ...editingDevice, currency: e.target.value })}
                      >
